...
export const twButtonStyles: Record<ButtonColor, string> = {
	info: `
    text-orange-500 hover:text-white border border-orange-500 hover:bg-orange-600/70 
    focus:ring-4 focus:outline-none focus:ring-orange-300 focus:ring-offset-2 focus:ring-1
    font-medium 
    rounded-lg 
    text-sm px-5 py-2.5 text-center  
    dark:border-orange-400 dark:text-orange-400 
    dark:hover:text-white dark:hover:bg-orange-400/70 
