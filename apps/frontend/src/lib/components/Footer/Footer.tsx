import { Text, Link, Logo, Title } from "@lib/components";
				...
				<section className="flex items-center justify-center mb-4" >
					...
					<div className="flex flex-col gap-2 w-1/5">
						<Title order={6}>Follow us!</Title>
							...
							<Link href="https://www.linkedin.com/company/the-signpost-project/?originalSubdomain=sg"external>
								Linkedin
							</Link>
							<Link href="https://www.facebook.com/thesignpostproject/" external>Facebook</Link>
							<Link href="https://www.instagram.com/thesignpostproject/" external>Instagram</Link>
						
					</div>
          <div className="flex flex-col gap-2  w-1/5">
            <Title order={6}>Resources</Title>
            <Link href="https://www.thesignpostproject.org/" external>Main website</Link>
